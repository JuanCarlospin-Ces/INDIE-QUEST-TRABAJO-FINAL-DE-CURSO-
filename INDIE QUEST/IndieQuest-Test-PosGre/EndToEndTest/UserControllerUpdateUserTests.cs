...
public class UserControllerUpdateUserTests
{
    ...
    {
        // Arrange
        var existingUser = new User { UserId = 1, Username = "old_name", Password = "oldpass", Email = "old@example.com", dateOfRegistration = DateTime.UtcNow };

        var mockRepo = new Mock<IUserRepository>();
        mockRepo.Setup(r => r.GetUserByIdAsync(1)).ReturnsAsync(existingUser);
        ...
        // Act
        var result = await controller.UpdateUser(1, command);
    ...
    public async Task UpdateUser_ShouldReturnNotFound_WhenUserDoesNotExist()
    {
        // Arrange
        var mockRepo = new Mock<IUserRepository>();
        mockRepo.Setup(r => r.GetUserByIdAsync(99)).ReturnsAsync((User?)null);
        ...
        // Act
        var result = await controller.UpdateUser(99, command);
